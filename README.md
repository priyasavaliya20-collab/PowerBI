...
Open PR_1_DATA_LEVERAGER.pbix in Microsoft Power BI Desktop
Go to Transform Data to open Power Query Editor
Navigate through the 13 queries in the Queries pane on the left
Update the FolderPath parameter if your sales files are in a different location
Click Close & Apply to load transformations into the data model
