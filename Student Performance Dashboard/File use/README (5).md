...
🔹 3️⃣ Visualizations
📌 Academic View Page
Screenshot 2026-04-27 232553
Screenshot 2026-04-27 232938
KPI Cards:
...
Screenshot 2026-04-27 231928
Screenshot 2026-04-27 233028
Screenshot 2026-04-27 233111
KPI Cards:
...
📌 Tooltip Page
Screenshot 2026-04-27 232804
Screenshot 2026-04-27 232834
...
Open Student_Performance_Dashboard.pbix in Microsoft Power BI Desktop
Navigate across the report tabs using the Academic View and Behavioral View bookmark buttons
Use slicers to filter by Class, Section, Subject, or Term
Right-click any student in the table → Drillthrough → Student Profile to view individual metrics
Hover over bars in the Average Score chart to see the custom Tooltip
Go to Table View to inspect DAX measures
Open the Fields Pane to browse the Measure Management table
